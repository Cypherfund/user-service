...
public class CoinService {
    ...
    @Transactional
    public TAccountBalanceDto coinReward(String userId, double amount, Enumerations.TRANSACTION_TYPE type, String reference) {
        ...
        createTransaction(userId, type, amount, reference);
